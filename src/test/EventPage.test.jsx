      ...
      detections: [
        {
          ...
          post_url: 'https://bsky.app/profile/did:plc:bus/post/thin77',
          resolved_post_url: 'https://bsky.app/profile/did:plc:bus/post/thin77clear',
          description: 'Route 77 thin-service gap',
          evidence: {
            signals: ['thin-gap'],
            ...
            resolved_description:
              'Buses observed on Route 77 again — earlier thin-service gap has cleared.',
            updates: [
              {
                ts: NOW - 2 * 60 * 60_000,
                description:
              ...
              },
              {
                ts: NOW - 60 * 60_000,
                description:
                  '🚌 Route 77 · still no buses observed — ~2h in, ~4 scheduled trips missed so far.',
                post_url: null,
...
describe('EventPage', () => {
  ...
  it('renders hourly progress updates on a bot-only absence incident timeline', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText(/Route 77 thin-service gap/)).toBeInTheDocument();
    });
