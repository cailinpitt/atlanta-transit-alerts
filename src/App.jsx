...
import MartaUpcomingCancellations from './components/MartaUpcomingCancellations.jsx';
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gh-canvas flex flex-col">
      ...
      <main id="main" tabIndex={-1} className="max-w-5xl mx-auto px-4 py-6 space-y-6 w-full">
        ...
        {data && (
          <>
            {/* Forward-looking strip: departures MARTA has announced won't run
                but haven't yet reached their scheduled time. Sits above the
                status block, separate from the live-disruption cards. */}
            <MartaUpcomingCancellations incidents={activeIncidents} now={now} showLine />
