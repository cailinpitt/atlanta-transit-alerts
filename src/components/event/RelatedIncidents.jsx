      ...
      <div className="relative flex items-start gap-3 flex-1 min-w-0 pointer-events-none [&_a]:pointer-events-auto [&_button]:pointer-events-auto">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-1.5 mb-1">
            ...
            {isDetourIncident(other) && <DetourBadge />}
          </div>
...
// Surrounding/cross-line lists can run long on a busy line (a rail trunk can
// surface many same-line incidents in a 24h window). Cap the visible rows so
// the event page doesn't end in a wall, with a "Show all N" toggle to expand.
// The cap is generous enough that quiet incidents show every row without it.
