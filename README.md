...
> **Port in progress.** This repo is a fork-first port of [`chicago-transit-alerts`](https://github.com/cailinpitt/chicago-transit-alerts) targeting MARTA / Atlanta. CTA/Metra-specific copy, metadata, and adapters are being replaced with MARTA equivalents per `plan.md`. Much of the documentation below still describes the Chicago site and is being rebranded incrementally.

A public archive of MARTA (Metropolitan Atlanta Rapid Transit Authority) service alerts and bot-detected disruptions, with a GitHub-style heatmap of incident frequency over the last 90 days. MARTA covers rail, bus, and the Atlanta Streetcar.

> **Unofficial project.** Not affiliated with, endorsed by, or sponsored by MARTA.
